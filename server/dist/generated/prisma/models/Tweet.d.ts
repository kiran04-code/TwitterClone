...
export type GetTweetAggregateType<T extends TweetAggregateArgs> = {
    [P in keyof T & keyof AggregateTweet]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateTweet[P]> : Prisma.GetScalarType<T[P], AggregateTweet[P]>;
};
...
type GetTweetGroupByPayload<T extends TweetGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<TweetGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof TweetGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], TweetGroupByOutputType[P]> : Prisma.GetScalarType<T[P], TweetGroupByOutputType[P]>;
}>>;
export type TweetWhereInput = {
    ...
    textContent?: Prisma.StringFilter<"Tweet"> | string;
...
export type TweetScalarWhereWithAggregatesInput = {
    ...
    textContent?: Prisma.StringWithAggregatesFilter<"Tweet"> | string;
...
export type TweetOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "textContent" | "imageUrl" | "authorId" | "createdAt" | "updatedAt", ExtArgs["result"]["tweet"]>;
...
export type TweetCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<TweetFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface TweetDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['Tweet'];
        meta: {
            name: 'Tweet';
        };
    };
     ...
     * })
    **/
    count<T extends TweetCountArgs>(args?: Prisma.Subset<T, TweetCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], TweetCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends TweetGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, TweetGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTweetGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface TweetFieldRefs {
    ...
    readonly textContent: Prisma.FieldRef<"Tweet", 'String'>;
